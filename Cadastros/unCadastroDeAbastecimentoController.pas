...
type
  ...
  public
    function AbastecimentoExiste(ACodigoAbastecimento: Integer): TAbastecimento;
...
function TCadastroAbastecimentoController.AbastecimentoExiste(
  ACodigoAbastecimento: Integer): TAbastecimento;
var
...
begin
  Persistencia := TAbastecimentoPersitencia.Create;
  try
    Result := Persistencia.Excluir(AAbastecimento);
  finally
    FreeAndNil(Persistencia);
  end;
end;
